<template>
  ...
  <footer class="c--content text-sm my-sm opacity-50">
    <div class="justify-between flex flex-row max-sm:flex-col max-sm:gap-sm max-md:items-start">
      ...
      <div class="flex flex-row gap-sm max-md:flex-col max-md:items-end max-md:gap-xs max-sm:items-start">
        <NuxtLink
          v-for="menu in menus"
        ...
        <NuxtLink
          ...
          class="ml-sm no-underline max-md:ml-0 max-md:mt-xs"
          target="_blank"
        >
